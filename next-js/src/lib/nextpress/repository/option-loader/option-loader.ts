...
{
    private dataLoader: DataLoader<string, Option | undefined, string>
    ...
    public static instance = cache(() => new OptionLoader());
    ...
    public async getOption(optionName: string): Promise<Option | undefined> {
